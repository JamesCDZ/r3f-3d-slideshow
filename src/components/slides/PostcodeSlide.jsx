  ...
  return (
    <div className="space-y-4" style={{ paddingTop: '2rem' }}>
      ...
      <div className="flex gap-3">
        ...
        <button
          onClick={onConfirm}
          className="flex-1 bg-[#33aae1] hover:bg-black text-white px-4 py-3 rounded-lg font-semibold transition-colors duration-200 text-sm"
        >
          Confirm & Continue
        </button>
      </div>
      ...
      {!addresses.length && !showManualEntry ? (
        <div className="space-y-4">
          ...
          <button
            onClick={findAddress}
            disabled={isLoadingAddresses}
            className="w-full bg-[#33aae1] hover:bg-black text-white disabled:bg-gray-400 px-6 py-3 rounded-lg font-semibold transition-colors duration-200"
          >
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-[#33aae1] hover:bg-black text-white disabled:opacity-50 disabled:cursor-not-allowed px-6 py-3 rounded-lg font-semibold transition-colors duration-200"
          >
            Continue
          </button>
        </div>
