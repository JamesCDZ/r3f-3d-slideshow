    ...
    <div className="text-center max-w-3xl mx-auto">
      ...
      <div className="grid grid-cols-3 gap-3 mb-6 text-xs md:text-sm">
        <div className="bg-blue-50 rounded-lg p-3 border border-blue-200 relative">
          <div className="absolute -top-2 -left-2 w-6 h-6 bg-teal-600 text-white rounded-full flex items-center justify-center text-xs font-bold">
            1
          </div>
        ...
        <div className="bg-green-50 rounded-lg p-3 border border-green-200 relative">
          <div className="absolute -top-2 -left-2 w-6 h-6 bg-teal-600 text-white rounded-full flex items-center justify-center text-xs font-bold">
            2
          </div>
          <div className="text-lg mb-1 w-[30px] mx-auto">
        ...
        <div className="bg-purple-50 rounded-lg p-3 border border-purple-200 relative">
          <div className="absolute -top-2 -left-2 w-6 h-6 bg-teal-600 text-white rounded-full flex items-center justify-center text-xs font-bold">
            3
          </div>
          <div className="text-lg mb-1 w-[30px] mx-auto">
      ...
      <div className="space-y-4">
        <button
          onClick={onNext}
          className="bg-teal-600 hover:bg-teal-700 text-white px-8 py-3 rounded-lg font-bold transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
        >
      ...
      {/* Process indicator */}
      <div className="mt-6 inline-flex items-center gap-2 bg-blue-100 px-4 py-2 rounded-full text-xs">
