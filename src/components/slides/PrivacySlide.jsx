...
const DealCard = ({ deal, index, isVisible }) => (
  <div 
    className={`bg-white rounded-lg shadow-md border border-gray-200 p-3 mb-3 transition-all duration-500 ${
  ...
  >
    ...
    <div className="flex flex-wrap gap-1">
      {deal.features.slice(0, 2).map((feature, idx) => (
        <div key={idx} className="flex items-center text-xs text-gray-500 bg-blue-50 px-2 py-1 rounded">
        ...
        <div>
          ...
          <div className="border border-blue-200 rounded-lg bg-blue-50 p-4 mb-4">
            <div className="flex items-center mb-3">
              ...
              <h3 className="font-semibold text-gray-800 text-sm">Your Data Preferences</h3>
          ...
          <div className="bg-gray-50 border border-gray-200 p-4 rounded-lg mb-4">
            <div className="flex items-center mb-2">
              ...
              <h4 className="font-medium text-gray-800 text-sm">Legal Requirements</h4>
            </div>
